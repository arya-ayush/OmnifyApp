...
public class TableAdapter extends RecyclerView.Adapter<RecyclerViewViewHolder> {
    private List<Integer> item;

    public TableAdapter(List<Integer> item) {
        this.item=item;
    }
    ...
    public void onBindViewHolder(RecyclerViewViewHolder holder, int position) {
        holder.regularTextView.setText(""+item.get(position));
    }
